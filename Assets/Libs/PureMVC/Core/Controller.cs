...
namespace PureMVC.Core
{
    ...
    public class Controller : IController
    {
        ...
        {
            Lazy<IController> alreadyPresentController;
            if (instanceMap.TryGetValue(key, out alreadyPresentController) && multitonKey != null) throw new Exception(MULTITON_MSG);
            multitonKey = key;
