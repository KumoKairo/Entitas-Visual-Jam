...
namespace Entitas {
    ...
    public abstract class AbstractEntityIndex<TKey> : IEntityIndex {
        ...
        protected void onEntityAdded(IGroup group, IEntity entity, Type componentType, IComponent component) {
            if (_isSingleKey) {
        ...
        protected void onEntityRemoved(IGroup group, IEntity entity, Type componentType, IComponent component) {
            if (_isSingleKey) {
